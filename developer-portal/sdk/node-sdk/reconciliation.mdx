...
You can find a list of request body parameters and possible outcomes <Link to="https://api-reference.checkout.com/#tag/Reconciliation">here</Link>.
...
In case the API response contains a next page, the page identifier will be injected in the response object as "page".
