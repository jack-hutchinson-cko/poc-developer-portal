...
<a href="https://www.checkout.com/get-test-account" target="_blank" className="get-test-account">Get a test account</a>
...
The SDK makes use of dynamic payloads both for the requests and for the API responses. If you want to see all the parameters that you can provide, as well as examples of possible responses, please follow the Checkout.com <Link to="https://api-reference.checkout.com/">API Reference</Link>.
