...
<Information type="note">
    You can also test 3D Secure with the test cards provided. If you want to test 3DS 2 flows, use the cards mentioned <a href="https://docs.checkout.com/docs/testing#section-3-ds-test-cards">here</a>
</Information>
